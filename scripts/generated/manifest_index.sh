...
ACFS_MANIFEST_SHA256="a8cf8bd754ab6cc0cd3dc08569d861f2cd304cdf5ce15309cc9703e1c692c7dd"
...
declare -gA ACFS_MODULE_DESC=(
  ...
  [agents.amp]="Sourcegraph Amp CLI"
...
declare -gA ACFS_MODULE_INSTALLED_CHECK=(
  ...
  [agents.amp]="test -x ~/.local/bin/amp"
