...
# Update agent CLIs
alias uca='~/.local/bin/claude update --channel latest && (bun install -g --trust @openai/codex@latest || bun install -g --trust @openai/codex) && bun install -g --trust @google/gemini-cli@latest'
